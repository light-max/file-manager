...
public class filetool
{
	...
	public static void fileAutoOpen(Context context,File fp)
	{
		Intent intent = new Intent();  
		intent.setAction(Intent.ACTION_VIEW);  
		String type = getMIMEType(fp);  
		intent.setDataAndType(Uri.fromFile(fp),type);
		context.startActivity(intent);    
	}
   ...
   //	intent.putExtra(Intent.EXTRA_SUBJECT,  context.toString()); 
	...
	public static void ShareFile(Context context,List<File> file)
	{
